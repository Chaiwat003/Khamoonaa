...
@st.cache_resource
def load_rag():
    return RAGEngine("knowledge/Nomnaa_kb.txt")


rag = load_rag()

st.title("🥛 Demi ผู้ช่วย AI ของ Nomnaa°")
...
if prompt := st.chat_input("ถามอะไรเกี่ยวกับร้านได้เลย..."):
    ...
    # Generate
    full_prompt = f"""คุณคือ Demi ผู้ช่วย AI ของร้าน Nomnaa° ตอบเฉพาะจากข้อมูลด้านล่าง
